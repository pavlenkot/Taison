        ...
        {status === "sent" ? (
          <div className="card text-center">
            <div className="mb-5 flex justify-center">
              <span className="icon-circle !size-20 text-positive">
                <Icon name="documents" size={40} />
              </span>
            </div>
            <p className="font-semibold">Лист надіслано</p>
            <p className="mt-1.5 text-sm text-muted">
              Відкрийте посилання з листа на{" "}
              <strong className="text-ink">{email}</strong>. Воно одразу вас
              впустить — пароль не потрібен.
            </p>
            <button
          ...
          <div className="space-y-3">
            <div className="card">
              <button
                ...
                className="btn-primary google-button w-full"
              >
            ...
            <form onSubmit={submit} className="card">
              ...
              <p className="mt-3 text-center text-xs text-muted">
                Ми надішлемо одноразове посилання. Паролів немає. Диск при цьому
                не підключається.
              </p>
            </form>
          </div>
